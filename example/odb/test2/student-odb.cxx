...
namespace odb
{
  ...
  bool access::view_traits_impl< ::classes_student, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
  ...
  void access::view_traits_impl< ::classes_student, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i)
  {
    using namespace mysql;
  ...
  access::view_traits_impl< ::classes_student, id_mysql >::query_base_type
