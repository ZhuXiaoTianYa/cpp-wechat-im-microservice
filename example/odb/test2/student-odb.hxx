...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::classes_student >
  {
    static const class_kind kind = class_view;
  };

  template <>
  class access::view_traits< ::classes_student >
  {
    public:
...
namespace odb
{
  ...
  struct query_columns< ::Student, id_mysql, A >
  {
    ...
    static const classes_id_type_ classes_id;
  };
  ...
  template <typename A>
  const typename query_columns< ::Student, id_mysql, A >::classes_id_type_
  query_columns< ::Student, id_mysql, A >::
  classes_id (A::table_name, "`classes_id`", 0);
    ...
    public access::object_traits< ::Student >
  {
    ...
    struct image_type
    {
      ...
      // _classes_id
      //
      unsigned long long _classes_id_value;
      my_bool _classes_id_null;
  ...
  //
  template <>
  class access::view_traits_impl< ::classes_student, id_mysql >:
    public access::view_traits< ::classes_student >
  {
    public:
    struct image_type
    {
  ...
  struct alias_traits<
    ::Classes,
    id_mysql,
    access::view_traits_impl< ::classes_student, id_mysql >::classes_tag>
  {
    static const char table_name[];
  };

  struct access::view_traits_impl< ::classes_student, id_mysql >::query_columns
  {
    // Student
    //
    typedef
