...
namespace im_server
{
    ...
    // FLAGS_user, FLAGS_passwd, FLAGS_db, FLAGS_host, FLAGS_port, "", FLAGS_charset, 0, std::move(cpf)
    class ODBFactory
    {
    public:
        static std::shared_ptr<odb::core::database> create(const std::string &user, const std::string &passwd, const std::string &host, const std::string &db, const std::string &cset, const int &port, const int &conn_pool_count)
        {
