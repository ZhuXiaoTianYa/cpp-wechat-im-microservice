...
DEFINE_string(access_host, "127.0.0.1:9004", "当前实例化外部访问地址");

DEFINE_int32(listen_port, 9004, "Rpc服务监听端口");
...
int main(int argc, char *argv[]) {
    ...
    usb.make_mysql_object(FLAGS_mysql_user, FLAGS_mysql_passwd,
    ...
    usb.make_registry_object(FLAGS_registry_host,
                             ...
                             FLAGS_access_host);
    usb.make_rpc_object(FLAGS_listen_port, FLAGS_rpc_timeout,
                        FLAGS_rpc_threads);
